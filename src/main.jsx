...
function Dashboard({ sessions, projects, quotas, onOpen, onNew, onEdit, onFavorite, onProjects, onFinances, onRefreshQuotas }) {
  ...
  const antigravitySessions = sessions.filter(({ assistant }) => assistant === "antigravity").length;
